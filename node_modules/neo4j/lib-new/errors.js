...
(function() {
  ...
  this.Error = (function(_super) {
    ...
    Error._fromResponse = function(resp) {
      var ErrorClass, ErrorType, body, headers, logBody, message, reqText, statusCode, statusText;
    ...
    Error._fromTransaction = function(obj) {
      var ErrorClass, category, classification, code, message, neo, title, _ref;
      ...
      message = "[" + category + "." + title + "] " + (message || '(no message)');
      return new ErrorClass(message, obj);
    };
